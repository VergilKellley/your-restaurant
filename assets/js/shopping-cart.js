...
function updateCartUI(){
    ...
    for(const [key, value] of items.entries()){
        ...
        <img src="${value.img}"> 
                       <div class="details">
                           ...
                           <p style="color:black">${value.desc}
                            ...
                            <span style="color:black" class="price">Price: $ ${price  = (Math.round(price * 100) / 100).toFixed(2)}</span>
                           </p>
                       </div>
       ...
       cartItem.lastElementChild.addEventListener('click', ()=>{
        ...
        subtotal.innerHTML = `Subtotal: $ ${total = (Math.round(total * 100) / 100).toFixed(2)}`
    }
    else
    cartIcon.classList.remove('non-empty')
