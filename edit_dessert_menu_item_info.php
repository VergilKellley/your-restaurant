                ...
                <div style="margin-top:10px">
                    ...
                    <div style="display:flex; justify-content:space-around">
                        <div style="display:flex; flex-direction:column; width:70%">
                            ...
                            <p><?= $menu_info['dessert_menu_item_num'] ?></p>
                            <br>
                            <p style='font-weight:bold'>image description:</p>
                            <p><?= $menu_info['dessert_menu_item_img_desc'] ?></p>
                        </div>
                        ...
                        <div style="display:flex; flex-direction:column">
                            ...
                            <img style="height:100px; width:100px"
                                src="assets/images/<?= $menu_info['dessert_menu_item_img']; ?>" alt="">
                        </div>
                    </div>
                </div>
                <?php                   
                        echo "
                            ...
                            <p><a class='btn btn-edit' href='backend/update_edit_dessert_menu_item_img.php?id=" . $menu_info['id'] . "'>Edit</a></p>
                        </div>";                       
                    ?>
            </div>
        </div>
                        ...
                        <div style="display:flex; flex-direction: column; margin-top:15px">
                            ...
                            <div style="display:flex; justify-content:space-around">
                                ...
                                <div style="display:flex; flex-direction:column; width:50%">
                                    <p style="margin-bottom:10px; font-weight:bold">current image:</p>
                                    <img style="height:100px; width:100px"
                                        src="assets/images/<?= $menu_info['dessert_menu_item_img']; ?>" alt="<?= $menu_info['dessert_menu_item_img_desc']; ?>">
                                </div>
                            </div>
                            <br>
                        </div>
                    ...
                    <div style="display:flex; margin-top:40px; align-items:center; justify-content:center">
                        <?php                   
                                echo "
                                    ...
                                    <p><a class='btn btn-edit' href='backend/update_edit_dessert_menu_item_info.php?id=" . $menu_info['id'] . "'>Edit</a></p>
                                </div>";                       
                            ?>
                        ...
                        <div>
                            <?php
                         echo "
                            <form action='backend\delete_dessert_menu_item.php' method='POST'>
