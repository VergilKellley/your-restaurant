...
if (($_SERVER["REQUEST_METHOD"] != "POST") || (!isset($_SESSION["user_id"]))) {
    ...
    // $fileName = $_FILES["image"]["name"];
        ...
        $update_footer_info_query = "UPDATE footer SET footer_facebook = '$footer_facebook', footer_instagram = '$footer_instagram' WHERE id = $footer_info_id;";
...
if (($_SERVER["REQUEST_METHOD"] != "POST") || (!isset($_SESSION["user_id"]))) {
    ...
    // $fileName = $_FILES["image"]["name"];
        ...
        if(!mysqli_errno($conn)) {
               header ('location: ../edit_footer_social_media_info.php');
            die();
            } else {
                header ('location: ../edit_footer_social_media_info.php');
                die();
