    ...
    <body>
        ...
        <section style='padding: 20px; width:100vw; display:flex; justify-content: center; align-content:center'>
            <div style='width: 100%; max-width: 525px;'>
                <a style='font-size:18px' href="../edit_upcoming_events_info.php#edit-info-3"> Back</a>
                <h2 style='font-size:22px; padding: 30px;'>edit upcoming events title & text 3</h2>
                <form style=" display:flex; flex-direction:column; gap 1rem; width:100%"
                    ...
                    <div style="display: flex; flex-direction:column; font-size:22px; gap: 1rem">
                        ...
                        <label for="small_top_img_title_3">title:</label>
                        <input style="padding:10px; font-size: 22px" type="text" name="upcoming_events_img_title_3"
                        id="small_top_img_title_3" value="<?= $upcoming_events_info['upcoming_events_img_title_3'] ?>" />                     

                        <label for="upcoming_events_img_text_3">text 3</label>
                        <input style="padding:10px; font-size: 22px" type="text" name="upcoming_events_img_text_3"
                        id="upcoming_events_img_text_3" value="<?= $upcoming_events_info['upcoming_events_img_text_3'] ?>" />

                        <button style=" font-size: 22px" type="submit" name="submit_update_upcoming_events_info_3">Update</button>
                    </div>
                </form>
            </div>
        </section>
