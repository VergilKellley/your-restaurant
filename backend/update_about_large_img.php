    ...
    <body>
        <section style='padding: 20px; width:100vw; display:flex; justify-content: center; align-content:center'>
            <div style='width: 100%; max-width: 525px;'>
                <a style='font-size:18px' href="../edit_about_info#large-img"> Back</a>
                ...
                <form style=" display:flex; flex-direction:column; gap 1rem; width:100%"
                    ...
                    <div style="display: flex; flex-direction:column; font-size:22px; gap: 1rem">
                        ...
                        <label for="about_img">large image</label>

                        <input style=" font-size: 22px; padding:10px" type="file" name="image" id="about_large_img"
                            value="<?= $about_info['about_large_img'] ?>" />

                        <label for="about_img_desc_1">large image description</label>

                        <input style="padding:10px; font-size: 22px" type="text" name="about_img_desc" id="about_large_img_desc" value="<?= $about_info['about_large_img_desc'] ?>" />

                        <button style=" font-size: 22px" type="submit" name="submit_update_about_large_img">Update</button>
                    </div>
                </form>
            </div>
        </section>
