            ...
            <div style='width: 100%; max-width: 525px;'>
                ...
                <form style=" display:flex; flex-direction:column; gap 1rem; width:100%"
                    ...
                    <div style="display: flex; flex-direction:column; font-size:22px; gap: 1rem">
                        ...
                        <label for="drinks_menu_item_img">image</label>

                        <input style=" font-size: 22px; padding:10px" type="file" name="image" id="menu_item_img"
                            value="<?= $menu_item_info['drinks_menu_item_img'] ?>" />

                        <label for="drinks_menu_item_img_desc">image description</label>

                        <input style="padding:10px; font-size: 22px" type="text" name="drinks_menu_item_img_desc"
                            id="drinks_menu_item_img_desc" value="<?= $menu_item_info['drinks_menu_item_img_desc'] ?>" />

                        <button style=" font-size: 22px" type="submit" name="submit_update_drinks_menu_item_img">Update
                        </button>
                    </div>
                </form>
            </div>
