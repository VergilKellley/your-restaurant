            ...
            <div style='width: 100%; max-width: 525px;'>
                ...
                <form style=" display:flex; flex-direction:column; gap 1rem; width:100%"
                    ...
                    <div style="display: flex; flex-direction:column; font-size:22px; gap: 1rem">
                        ...
                        <label for="special_dish_img">background image</label>

                        <input style=" font-size: 22px; padding:10px" type="file" name="image" id="special_dish_bkgd_img"
                            value="<?= $special_dish_img['special_dish_bkgd_img'] ?>" />

                        <label for="special_dish_img_desc">image description:</label>

                        <input style="padding:10px; font-size: 22px" type="text" name="special_dish_bkgd_img_desc" id="special_dish_bkgd_img_desc" value="<?= $special_dish_img['special_dish_bkgd_img_desc'] ?>" />

                        <button style=" font-size: 22px" type="submit" name="submit_update_special_dish_bkgd_img">Update</button>
                    </div>
                </form>
            </div>
        </section>
