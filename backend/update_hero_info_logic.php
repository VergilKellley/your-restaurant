...
// HERO IMG 1
if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit_update_hero_img_1'])) {
...
// HERO INFO-TEXT 1
if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit_update_hero_info_1'])) {
...
if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit_update_hero_info_3'])) {
