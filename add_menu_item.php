...
<body>
    <section class="stylist_info_container" style="height: 100vh; display:grid; place-items:center;">
        ...
        <div id='form-container' style="display: flex; gap:4rem; padding: 20px">
            <form action="backend/add_new_menu_item_logic.php" class="stylist_form" method="POST" enctype="multipart/form-data">
                <br>
                <div style="display: flex; flex-direction:column; gap:1rem">
                    <label for="entre_menu_item_num">item number:</label>
                    <input type="text" name="entre_menu_item_num" id="entre_menu_item_num" placeholder="enter item number">

                    <label for="entre_menu_item_name">item name:</label>
                    <input type="text" name="entre_menu_item_name" id="entre_menu_item_name" placeholder="Enter entre name">

                    <label for="menu_item_img">choose image</label>
                    ...
                    <input type="text" name="entre_menu_item_img_desc" id="entre_menu_item_img_desc" placeholder="describe image">             

                    <label for="entre_menu_item_desc">new or seasonal item:</label>
                    <input type="text" name="entre_menu_item_desc" id="entre_menu_item_desc" placeholder="Seasonal">

                    <label for="entre_menu_item_price">item price"</label>
                    <input type="text" name="entre_menu_item_price" placeholder="19.99">

                    <label for="menu_item_text">item description:</label>
                    <input type="text" name="entre_menu_item_text" placeholder="Describe entre">

                    <button name="submit_add_new_menu_item" class="btn btn-blk">SAVE</button>
                </div>
            </form>
