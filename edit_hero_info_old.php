                ...
                <div class='nth-child-bkgd-color'
                    ...
                    <p style="max-width:100vw">
                        <span style="display:flex; flex-direction:column; align-items:center; font-weight:bold">hero
                            image:
                            <img style='width:100%' src='assets/images/<?= $hero_info_1['hero_img_1'] ?>' value='<?= $hero_img_1; ?>'
                                alt="<?= $hero_info_1['hero_img_desc_1']; ?>">
                        </span>
                    </p>
                    <p style="max-width:100vw">
                    ...
                    <p style="max-width:100vw">
                        <span style='font-weight:bold'>bottom small text:<?= $hero_info_1['hero_bottom_text_1']; ?></span>
                    </p>
                    <p style="max-width:100vw">
                        <span style='font-weight:bold'>top button text: <?= $hero_info_1['hero_top_btn_text_1']; ?></span>
                    </p>
                    <p style="max-width:100vw">
                        <span style='font-weight:bold;overflow-wrap: break-word;'>top button link: <?= $hero_info_1['hero_top_btn_link_1']; ?></span>
                    </p>
                    <p style="max-width:100vw">
        ...
        <div class='mobile-edit-photos' style='max-width:500px'>
            ...
            <div
                ...
                <div class='nth-child-bkgd-color'
                    ...
                    <p style="max-width:100vw">
                        <span style='font-weight:bold'>bottom small text:<?= $hero_info_2['hero_bottom_text_2']; ?></span>
                    </p>
                    <p style="max-width:100vw">
                        <span style='font-weight:bold'>top button text: <?= $hero_info_2['hero_top_btn_text_2']; ?></span>
                    </p>
                    <p style="max-width:100vw">
                        <span style='font-weight:bold;overflow-wrap: break-word;'>top button link: <?= $hero_info_2['hero_top_btn_link_2']; ?></span>
                    </p>
                    <p style="max-width:100vw">
                        <span style='font-weight:bold'>bottom button text:
        ...
        <div class='mobile-edit-photos' style='max-width:500px'>
            ...
            <div
                ...
                <div class='nth-child-bkgd-color'
                    ...
                    <p style="max-width:100vw">
                        <span style='font-weight:bold'>bottom small text:<?= $hero_info_3['hero_bottom_text_3']; ?></span>
                    </p>
                    <p style="max-width:100vw">
                        <span style='font-weight:bold'>top button text: <?= $hero_info_3['hero_top_btn_text_3']; ?></span>
                    </p>
                    <p style="max-width:100vw">
                        <span style='font-weight:bold;overflow-wrap: break-word;'>top button link: <?= $hero_info_3['hero_top_btn_link_3']; ?></span>
                    </p>
                    <p style="max-width:100vw">
                        <span style='font-weight:bold'>bottom button text:
