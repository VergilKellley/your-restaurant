                    ...
                    <div class='nth-child-bkgd-color'
                        ...
                        <p style="max-width:100vw">
                            <span
                                ...
                                image 1:
                                <img style='width:100px' src='assets/images/<?= $our_strengths_info['our_strengths_img_1'] ?>'
                    ...
                    <div class='nth-child-bkgd-color'
                        ...
                        <p style="max-width:100vw">
                            <span
                                style="display:flex; flex-direction:column; align-items:center; font-weight:bold">
                                image:
                                <img style='width:100px' src='assets/images/<?= $our_strengths_info['our_strengths_img_2'] ?>'
...
<div class='mobile-edit-photos' style='max-width:500px'>
            ...
            <div
                ...
                <div class='nth-child-bkgd-color'
                    ...
                    <p style='font-weight:bold'>text:</p>
                    <p style="max-width:100vw">
                        <span><?=$our_strengths_info['our_strengths_img_text_2']; ?>
                        </span>
                    </p>
                    <br>
                    <?php
                    ...
                    <div class='nth-child-bkgd-color'
                        ...
                        <p style="max-width:100vw">
                            <span
                                style="display:flex; flex-direction:column; align-items:center; font-weight:bold">
                                image:
                                <img style='width:100px' src='assets/images/<?= $our_strengths_info['our_strengths_img_3'] ?>'
...
<div class='mobile-edit-photos' style='max-width:500px'>
            ...
            <div
                ...
                <div class='nth-child-bkgd-color'
                    ...
                    <p style='font-weight:bold'>text:</p>
                    <p style="max-width:100vw">
                        <span><?=$our_strengths_info['our_strengths_img_text_3']; ?>
                        </span>
                    </p>
                    <br>
                    <?php
        ...
        <div class='form-container' style="display: flex; flex-direction:column; gap:4rem;">
                    ...
                    <div class='nth-child-bkgd-color'
                        ...
                        <p style="max-width:100vw">
                            <span
                                style="display:flex; flex-direction:column; align-items:center; font-weight:bold">
                                image:
                                <img style='width:100px' src='assets/images/<?= $our_strengths_info['our_strengths_img_4'] ?>'
           ...
           <div class='mobile-edit-photos' style='max-width:500px'>
            <div>
                <h2 id="edit-info-4">image info 4</h2>
            </div>
            <br>
            <div
                style=" display: flex; flex-direction:column; align-items:center; gap:1rem; overflow-y:scroll; border:1px solid #333; padding: 10px">
                ...
                <div class='nth-child-bkgd-color'
                    ...
                    <p style='font-weight:bold'>text:</p>
                    <p style="max-width:100vw">
                        <span><?=$our_strengths_info['our_strengths_img_text_4']; ?>
                        </span>
                    </p>
                    <br>
                    <?php
